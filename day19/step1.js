...
let productArray = [
{ pno : 1 , pname : '블랙바비큐콰트로' , pprice : 19000 , pimg : '블랙바비큐콰트로.png' , cno : 1  } ,
{ pno : 2 , pname : '큐브스테이크와퍼' , pprice : 25000 , pimg : '큐브스테이크와퍼.png', cno : 3  } ,
{ pno : 3 , pname : '통새우와퍼' , pprice : 17000 , pimg : '통새우와퍼.png', cno : 4 } ,
]
...
for( let i = 0 ; i<categoryArray.length ; i++ ){ //5개의 카테고리 만들기        for i = 0 > html li onclick =printCategory(1)
    
    // 만약에 i번째 카테고리의 cno와 내가선택한cno[매개변수] 와 같으면                       i = 1 > html li onclick printCategory(2)
